  ...
  User.find_or_create_by_id(id:23, name:'Carl Daly',         username:'carld',  password:'abc')
  User.find_or_create_by_id(id:23, name:'Gene Coates',       username:'genec',  password:'abc')
