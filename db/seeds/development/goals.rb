...
if TOGGLES_CONFIG['five_alive']
  ...
  Goal.create(score_id: 1, player_id: Player.where(surname: 'Valencia', forename: 'A').first.id)
  ...
  Goal.create(score_id: 3, player_id: Player.where(surname: 'Suarez', forename: 'L').first.id)
  Goal.create(score_id: 3, player_id: Player.where(surname: 'Suarez', forename: 'L').first.id)
  Goal.create(score_id: 3, player_id: Player.where(surname: 'Suarez', forename: 'L').first.id)
