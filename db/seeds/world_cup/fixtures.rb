...
Fixture.find_or_create_by_id(:id => 7,  :kickoff => DateTime.parse('2014-06-14 16:00:00'), :name => 'URU-COS', :home_team_id => 31, :away_team_id => 11, :week_id => 1)
...
Fixture.find_or_create_by_id(:id => 19, :kickoff => DateTime.parse('2014-06-18 16:00:00'), :name => 'SPA-CHI', :home_team_id => 29, :away_team_id => 8,  :week_id => 2)
Fixture.find_or_create_by_id(:id => 20, :kickoff => DateTime.parse('2014-06-18 13:00:00'), :name => 'AUS-NET', :home_team_id => 3,  :away_team_id => 25, :week_id => 2)
Fixture.find_or_create_by_id(:id => 21, :kickoff => DateTime.parse('2014-06-19 13:00:00'), :name => 'COL-COT', :home_team_id => 9,  :away_team_id => 10, :week_id => 2)
Fixture.find_or_create_by_id(:id => 22, :kickoff => DateTime.parse('2014-06-19 19:00:00'), :name => 'JAP-GRE', :home_team_id => 22, :away_team_id => 18, :week_id => 2)
Fixture.find_or_create_by_id(:id => 23, :kickoff => DateTime.parse('2014-06-19 16:00:00'), :name => 'URU-ENG', :home_team_id => 31, :away_team_id => 14, :week_id => 2)
Fixture.find_or_create_by_id(:id => 24, :kickoff => DateTime.parse('2014-06-20 13:00:00'), :name => 'ITA-COS', :home_team_id => 21, :away_team_id => 11, :week_id => 2)
Fixture.find_or_create_by_id(:id => 25, :kickoff => DateTime.parse('2014-06-20 16:00:00'), :name => 'SWI-FRA', :home_team_id => 30, :away_team_id => 15, :week_id => 2)
Fixture.find_or_create_by_id(:id => 26, :kickoff => DateTime.parse('2014-06-20 19:00:00'), :name => 'HON-ECU', :home_team_id => 19, :away_team_id => 13, :week_id => 2)
Fixture.find_or_create_by_id(:id => 27, :kickoff => DateTime.parse('2014-06-21 13:00:00'), :name => 'ARG-IRA', :home_team_id => 2,  :away_team_id => 20, :week_id => 2)
Fixture.find_or_create_by_id(:id => 28, :kickoff => DateTime.parse('2014-06-21 18:00:00'), :name => 'NIG-BOS', :home_team_id => 26, :away_team_id => 5,  :week_id => 2)
Fixture.find_or_create_by_id(:id => 29, :kickoff => DateTime.parse('2014-06-21 16:00:00'), :name => 'GER-GHA', :home_team_id => 16, :away_team_id => 17, :week_id => 2)
Fixture.find_or_create_by_id(:id => 30, :kickoff => DateTime.parse('2014-06-22 18:00:00'), :name => 'USA-POR', :home_team_id => 32, :away_team_id => 27, :week_id => 2)
Fixture.find_or_create_by_id(:id => 31, :kickoff => DateTime.parse('2014-06-22 13:00:00'), :name => 'BEL-RUS', :home_team_id => 4,  :away_team_id => 28, :week_id => 2)
Fixture.find_or_create_by_id(:id => 32, :kickoff => DateTime.parse('2014-06-22 16:00:00'), :name => 'KOR-ALG', :home_team_id => 23, :away_team_id => 1,  :week_id => 2)
...
Fixture.find_or_create_by_id(:id => 34, :kickoff => DateTime.parse('2014-06-23 17:00:00'), :name => 'CRO-MEX', :home_team_id => 12, :away_team_id => 24, :week_id => 3)
Fixture.find_or_create_by_id(:id => 35, :kickoff => DateTime.parse('2014-06-23 13:00:00'), :name => 'AUS-SPA', :home_team_id => 3,  :away_team_id => 29, :week_id => 3)
Fixture.find_or_create_by_id(:id => 36, :kickoff => DateTime.parse('2014-06-23 13:00:00'), :name => 'NET-CHI', :home_team_id => 25, :away_team_id => 8,  :week_id => 3)
Fixture.find_or_create_by_id(:id => 37, :kickoff => DateTime.parse('2014-06-24 16:00:00'), :name => 'JAP-COL', :home_team_id => 22, :away_team_id => 9,  :week_id => 3)
Fixture.find_or_create_by_id(:id => 38, :kickoff => DateTime.parse('2014-06-24 17:00:00'), :name => 'GRE-COT', :home_team_id => 18, :away_team_id => 10, :week_id => 3)
Fixture.find_or_create_by_id(:id => 39, :kickoff => DateTime.parse('2014-06-24 13:00:00'), :name => 'ITA-URU', :home_team_id => 21, :away_team_id => 31, :week_id => 3)
Fixture.find_or_create_by_id(:id => 40, :kickoff => DateTime.parse('2014-06-24 13:00:00'), :name => 'COS-ENG', :home_team_id => 11, :away_team_id => 14, :week_id => 3)
Fixture.find_or_create_by_id(:id => 41, :kickoff => DateTime.parse('2014-06-25 16:00:00'), :name => 'HON-SWI', :home_team_id => 19, :away_team_id => 30, :week_id => 3)
Fixture.find_or_create_by_id(:id => 42, :kickoff => DateTime.parse('2014-06-25 17:00:00'), :name => 'ECU-FRA', :home_team_id => 13, :away_team_id => 15, :week_id => 3)
Fixture.find_or_create_by_id(:id => 43, :kickoff => DateTime.parse('2014-06-25 13:00:00'), :name => 'NIG-ARG', :home_team_id => 26, :away_team_id => 2,  :week_id => 3)
Fixture.find_or_create_by_id(:id => 44, :kickoff => DateTime.parse('2014-06-25 13:00:00'), :name => 'BOS-IRA', :home_team_id => 5,  :away_team_id => 20, :week_id => 3)
Fixture.find_or_create_by_id(:id => 45, :kickoff => DateTime.parse('2014-06-26 13:00:00'), :name => 'USA-GER', :home_team_id => 32, :away_team_id => 16, :week_id => 3)
Fixture.find_or_create_by_id(:id => 46, :kickoff => DateTime.parse('2014-06-26 13:00:00'), :name => 'POR-GHA', :home_team_id => 27, :away_team_id => 17, :week_id => 3)
Fixture.find_or_create_by_id(:id => 47, :kickoff => DateTime.parse('2014-06-26 17:00:00'), :name => 'KOR-BEL', :home_team_id => 23, :away_team_id => 4,  :week_id => 3)
Fixture.find_or_create_by_id(:id => 48, :kickoff => DateTime.parse('2014-06-26 17:00:00'), :name => 'ALG-RUS', :home_team_id => 1,  :away_team_id => 28, :week_id => 3)
