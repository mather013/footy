...
#
#Fixture.find_or_create_by_id(:id => 191, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'ARS-CAR', :home_team_id => 1,  :away_team_id => 3,  :week_id => 20)
#Fixture.find_or_create_by_id(:id => 192, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'CRY-NOR', :home_team_id => 5,  :away_team_id => 13, :week_id => 20)
#Fixture.find_or_create_by_id(:id => 193, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'FUL-WHA', :home_team_id => 7,  :away_team_id => 20, :week_id => 20)
#Fixture.find_or_create_by_id(:id => 194, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'LIV-HUL', :home_team_id => 9,  :away_team_id => 8,  :week_id => 20)
#Fixture.find_or_create_by_id(:id => 195, :kickoff => DateTime.parse('2014-01-01 17:30:00'), :name => 'MUN-TOT', :home_team_id => 11, :away_team_id => 18, :week_id => 20)
#Fixture.find_or_create_by_id(:id => 196, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'SOU-CHE', :home_team_id => 14, :away_team_id => 4,  :week_id => 20)
#Fixture.find_or_create_by_id(:id => 197, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'STO-EVE', :home_team_id => 15, :away_team_id => 6,  :week_id => 20)
#Fixture.find_or_create_by_id(:id => 198, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'SUN-AST', :home_team_id => 16, :away_team_id => 2,  :week_id => 20)
#Fixture.find_or_create_by_id(:id => 199, :kickoff => DateTime.parse('2014-01-01 12:45:00'), :name => 'SWA-MCI', :home_team_id => 17, :away_team_id => 10, :week_id => 20)
#Fixture.find_or_create_by_id(:id => 200, :kickoff => DateTime.parse('2014-01-01 15:00:00'), :name => 'WBR-NEW', :home_team_id => 19, :away_team_id => 12, :week_id => 20)
#
#Fixture.find_or_create_by_id(:id => 201, :kickoff => DateTime.parse('2014-01-13 20:00:00'), :name => 'AST-ARS', :home_team_id => 2,  :away_team_id => 1,  :week_id => 21)
#Fixture.find_or_create_by_id(:id => 202, :kickoff => DateTime.parse('2014-01-11 15:00:00'), :name => 'CAR-WHA', :home_team_id => 3,  :away_team_id => 20, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 203, :kickoff => DateTime.parse('2014-01-11 15:00:00'), :name => 'EVE-NOR', :home_team_id => 6,  :away_team_id => 13, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 204, :kickoff => DateTime.parse('2014-01-11 15:00:00'), :name => 'FUL-SUN', :home_team_id => 7,  :away_team_id => 16, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 205, :kickoff => DateTime.parse('2014-01-11 12:45:00'), :name => 'HUL-CHE', :home_team_id => 8,  :away_team_id => 4,  :week_id => 21)
#Fixture.find_or_create_by_id(:id => 206, :kickoff => DateTime.parse('2014-01-11 17:30:00'), :name => 'MUN-SWA', :home_team_id => 11, :away_team_id => 17, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 207, :kickoff => DateTime.parse('2014-01-12 14:05:00'), :name => 'NEW-MCI', :home_team_id => 12, :away_team_id => 10, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 208, :kickoff => DateTime.parse('2014-01-11 15:00:00'), :name => 'SOU-WBR', :home_team_id => 14, :away_team_id => 19, :week_id => 21)
#Fixture.find_or_create_by_id(:id => 209, :kickoff => DateTime.parse('2014-01-12 16:10:00'), :name => 'STO-LIV', :home_team_id => 15, :away_team_id => 9,  :week_id => 21)
#Fixture.find_or_create_by_id(:id => 210, :kickoff => DateTime.parse('2014-01-11 15:00:00'), :name => 'TOT-CRY', :home_team_id => 18, :away_team_id => 5,  :week_id => 21)
