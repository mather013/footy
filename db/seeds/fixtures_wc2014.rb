...
Fixture.find_or_create_by_id(:id => 23, :kickoff => DateTime.parse('2014-06-19 16:00:00'), :name => 'UGU-ENG', :home_team_id => 31, :away_team_id => 14, :week_id => 2)
...
Fixture.find_or_create_by_id(:id => 39, :kickoff => DateTime.parse('2014-06-24 13:00:00'), :name => 'ITA-UGU', :home_team_id => 21, :away_team_id => 21, :week_id => 3)
