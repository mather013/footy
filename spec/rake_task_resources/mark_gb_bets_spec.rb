...
module RakeTaskResources
  describe MarkGbBets do
    ...
    describe ".perform" do
      ...
      let!(:fixture_7) { week_three.fixtures.create(id:7, status: status, kickoff: week_three_ko, home_team_id: 1, away_team_id: 4) }
      let!(:fixture_7_score) { fixture_7.create_score(home:0, away:0) }

      let!(:fixture_8) { week_three.fixtures.create(id:8, status: status, kickoff: week_three_ko, home_team_id: 2, away_team_id: 5) }
      ...
      let!(:fixture_9) { week_three.fixtures.create(id:9, status: status, kickoff: week_three_ko, home_team_id: 3, away_team_id: 6) }
      ...
      let!(:fixture_1) { week_one.fixtures.create(id:1, status: status, kickoff: week_one_ko, home_team_id: 1, away_team_id: 2) }
      ...
      let!(:fixture_2) { week_one.fixtures.create(id:2, status: status, kickoff: week_one_ko, home_team_id: 3, away_team_id: 4) }
      ...
      let!(:fixture_3) { week_one.fixtures.create(id:3, status: status, kickoff: week_three_ko, home_team_id: 5, away_team_id: 6) }
      ...
      let!(:fixture_4) { week_two.fixtures.create(id:4, status: status, kickoff: week_two_ko, home_team_id: 2, away_team_id: 1) }
      ...
      let!(:fixture_5) { week_two.fixtures.create(id:5, status: status, kickoff: week_two_ko, home_team_id: 4, away_team_id: 3) }
      ...
      let!(:fixture_6) { week_two.fixtures.create(id:6, status: status, kickoff: week_two_ko, home_team_id: 6, away_team_id: 5) }
