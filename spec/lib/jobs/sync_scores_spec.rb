  ...
  describe SyncScores do
    ...
    describe 'instance methods' do
      ...
      describe '#perform' do
        ...
        let(:fixture) { double(Fixture, feed_id: 999, score: score) }
        ...
        context 'when there are no fixtures that have recently finished' do
        ...
        context 'when there are fixtures that have recently finished' do
